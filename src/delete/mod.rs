...
impl fuse_file_info {
    ...
    pub fn padding(&self) -> ::std::os::raw::c_uint {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(32usize, 27u8) as u32) }
    }
    #[inline]
    pub fn set_padding(&mut self, val: ::std::os::raw::c_uint) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            self._bitfield_1.set(32usize, 27u8, val as u64)
        }
    }
    #[inline]
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(32usize, 27u8, {
...
#[doc = ""]
#[doc = " The *off* parameter can be any non-zero value that enableds the"]
...
pub struct fuse_operations {
    ...
    #[doc = " opened file, e.g. due to dup(), dup2() or fork() calls.  It is not"]
    #[doc = " possible to determine if a flush is final, so each flush should be"]
    #[doc = " treated equally.  Multiple write-flush sequences are relatively"]
